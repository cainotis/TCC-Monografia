...
\title{
    ...
    titlept={Estudo de caso em aprendizado por reforço no universo Duckietown},
    titleen={Reinforced learning on Duckietown},
    % Opcional, mas se houver deve existir nas duas línguas
    % subtitlept={um subtítulo},
    % subtitleen={a subtitle},
}

\author{Cainã Setti Galante}

% Para TCCs, este comando define o supervisor
\orientador{Prof. Denis Deratani Mauá}

% Se não houver, remova; se houver mais de um, basta
% repetir o comando quantas vezes forem necessárias
% \coorientador{Prof. Dr. Ciclano de Tal}
\coorientador[fem]{Profª. Nina S. T. Hirata}
...
\defesa{
  ...
  membrobanca={Profª. Drª. Nina S. T. Hirata -- IME-USP},
...
\begin{tabular}{rl}
   DQN & \emph{Deep-Q Networks}\\
    AI & Inteligência artificial (\emph{Artificial intelligence})\\
    Rl & Aprendizado por reforço (\emph{Reinforcement learning}) \\
  GPU & Unidade de processamento gráfico (\emph{Graphics processing unit})\\
...
\input{conteudo/01-duckietown}
\input{conteudo/02-dqn}
...
% \input{conteudo/exemplo/apendice-exemplo-pseudocodigo} 
\par
